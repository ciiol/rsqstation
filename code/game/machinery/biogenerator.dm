		...
		switch(menustat)
			if("menu")
				if (beaker)
					...
					dat += "Food<BR>"
					dat += "<A href='?src=\ref[src];action=create;item=milk;cost=20'>10 milk</A> <FONT COLOR=blue>(20)</FONT> | <A href='?src=\ref[src];action=create;item=milk10;cost=200'>x10</A><BR>"
					dat += "<A href='?src=\ref[src];action=create;item=meat;cost=50'>Slab of meat</A> <FONT COLOR=blue>(50)</FONT> | <A href='?src=\ref[src];action=create;item=meat5;cost=250'>x5</A><BR>"
					dat += "Nutrient<BR>"
